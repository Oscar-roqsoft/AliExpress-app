<template>
    <div id="ShoppingCartPage" class="mt-2 max-w-[1200px] mx-auto px-2">
        <div  v-if="false" 
            ...
            <div v-if="!user" class="flex text-center">
                <NuxtLink 
                    to="/auth"
                    class="bg-[#FD374F] w-full  text-white text-lg font-semibold px-7 py-1 rounded-full
                    mt-4 ">
                    Sign in
                </NuxtLink>
            </div>
            ...
            <div class="md:w-[35%]">
                <div id="Summary" class="bg-white rounded-lg p-4">
                    <div class="text-2xl font-extrabold mb-2">Summary</div>
                        ...
                        class="flex items-center justify-center  bg-[#FD374F]  w-full text-lg 
...
<script setup>
    ...
    onMounted(() => {
    setTimeout(() => userStore.isLoading = false, 200)  //for page loader
    })
